...
//  To Do List
//
//  Created by Kevin Wijendra on 9/26/17.
...
class ViewController: UIViewController {
    ...
    // var toDoArray = ["Learn Swift", "Commit Files", "Push to GitHub"]
    // var toDoNotesArray = ["Watch videos by Gallaugher.", "Connect Repo to the files.", "Make sure commits are up on the site."]
